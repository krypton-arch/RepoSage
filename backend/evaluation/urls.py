...
from .views import EvaluationCaseViewSet, run_evaluation, list_runs, compare_runs, delete_run
...
urlpatterns = [
    ...
    path('projects/<uuid:project_id>/evaluation/cases/<uuid:case_id>/runs/<uuid:run_id>/', delete_run, name='delete-run'),
